...
const NAV_ITEMS = [
  ...
  },
  {
    ...
    children: [
      {
        label: 'Ventajas y beneficios para estudiantes',
        subLabel: 'Conoce nuestros beneficios para estudiantes',
        href: '#',
      },
      {
        label: 'Ventajas y beneficios para anfitriones',
        subLabel: 'Conoce nuestros beneficios para anfitriones',
        href: '#',
      },
    ],
  },
