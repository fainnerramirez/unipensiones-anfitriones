            ...
            <FormControl isRequired>
              <InputGroup>
                <Select
                  value={tipoCupo}
                  icon={<MdArrowDropDown />}
                  placeholder="Seleccione el tipo de cupo"
                  color={"gray"}
                  onChange={(e) => setTipoCupo(e.target.value)}
                >
                  <option value="solo cupo">Solo cupo (habitación)</option>
                  <option value="cupo completo">
                    Cupo completo (habitación y comida)
                  </option>
                </Select>
              </InputGroup>
            </FormControl>
  ...
  return (
    <Stack spacing="10px" mt={10}>
      <Heading textAlign={"center"}>
        Selecciona todas las normas que quieras <br /> que los estudiantes
        cumplan
      </Heading>
        ...
        <AccordionItem>
          ...
          <AccordionPanel pb={4}>
            ...
            <Stack pl={6} mt={1} spacing={1}>
              ...
              >
                Tratar a los demás residentes con cortesía y consideración en
                todo momento.
              </Checkbox>
              <Checkbox
              ...
              >
                Establecer horarios en los que se debe mantener un ambiente
                tranquilo, especialmente durante las horas de estudio y
                descanso.
              </Checkbox>
              <Checkbox
              ...
              >
                Respetar y cuidar las áreas comunes, como la cocina, el baño y
                las zonas de estar. Limpiar y guardar los utensilios y equipos
                después de su uso.
              </Checkbox>
              <Checkbox
              ...
              >
                Respetar la privacidad de los demás, evitando entrar en las
                habitaciones de los compañeros sin su permiso.
              </Checkbox>
              <Checkbox
              ...
              >
                Notificar a la administración o compañeros de habitación sobre
                la llegada de visitantes y respetar las normas establecidas para
                las visitas
              </Checkbox>
            </Stack>
          </AccordionPanel>
        ...
        <AccordionItem>
          ...
          <AccordionPanel pb={4}>
            ...
            <Stack pl={6} mt={1} spacing={1}>
              ...
              >
                Limpiar después de usar los espacios comunes, incluyendo la
                cocina, áreas de estar y baños.
              </Checkbox>
              <Checkbox
                isChecked={checkedItems[1]}
              ...
              >
                Compartir los espacios comunes de manera equitativa y respetar
                el derecho de los demás a utilizarlos.
              </Checkbox>
              <Checkbox
                isChecked={checkedItems[3]}
                onChange={() => handleCheckboxChange(3)}
              >
                Respetar la privacidad de los demás al utilizar espacios comunes
                y no interferir con actividades privadas.
              </Checkbox>
              <Checkbox
                isChecked={checkedItems[4]}
                onChange={() => handleCheckboxChange(4)}
              >
                Reportar cualquier problema o daño a la administración de la
                pensión.
              </Checkbox>
            </Stack>
          </AccordionPanel>
...
const Previsualizacion = () => {
  return <Heading p={20}>Tu pensión esta lista para ser publicada</Heading>;
};
...
const ModalAnuncio = ({ isvalidPublished }) => {
  ...
  const [urlNequi, setUrlNequi] = useState(
    "https://drive.google.com/file/d/1N6zX2sp-FPdoNA1xUaVoJScS53DqBtq8/view?usp=drive_link"
  );
  const [urlMercadoPago, setUrlMercadoPago] = useState(
    "https://www.mercadopago.com.co/subscriptions/checkout?preapproval_plan_id=2c9380848c6efe38018c78e268e70389"
  );
  ...
  return (
    <>
      <Button
        ...
        onClick={onOpen}
      >
        <Text display={{ base: "none", md: "block" }}>publicar anuncio</Text>
      </Button>
            ...
            <form style={{ width: "100%" }} onSubmit={handleSubmitPublicForm}>
              ...
              >
                <VStack>
                  ...
                  <ModalBody>{currentStepComponent}</ModalBody>
          ...
          <ModalContent borderRadius={15}>
            <HStack display={"flex"} flexDir={"column"}>
              <ModalHeader textAlign={"center"} width={"100%"}>
                <Heading fontSize={30}>
                  Conviértete en un Superanfitrión
                </Heading>
              </ModalHeader>
              ...
              <ModalBody width={{ base: "100%", md: "95%" }}>
                <Card variant={"elevated"} borderRadius={15}>
                  ...
                  <CardFooter textAlign={"center"}>
                    <Heading fontSize={"xl"}>
                      Publica de manera ilimitada tus pensiones, destaca entre
                      todas las publicaciones, los estudiantes recibirán una
                      notificación directa de tus pensiones y mucho más.
                    </Heading>
                  </CardFooter>
                </Card>
              </ModalBody>
